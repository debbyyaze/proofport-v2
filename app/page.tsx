...
export const metadata: Metadata = {
  ...
  description:
    "Publish wallet-signed proof entries, optionally attach a public HTTPS proof link, and share explorer receipts anyone can verify.",
  alternates: {
    canonical: "/"
  },
  openGraph: {
      ...
      <section className="hero-workbench" aria-labelledby="home-title">
        <div className="hero-copy">
          ...
          <p className="hero-note" id="publish-visibility-note">
            ...
            summary, tag, wallet address, explorer receipt, public HTTPS proof
            link if attached, and any applause sent from your wallet.
          </p>
        </div>
        <section
